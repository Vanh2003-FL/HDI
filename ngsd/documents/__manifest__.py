# -*- coding: utf-8 -*-
{
    ...
    'depends': ['base', 'mail', 'portal', 'web', 'attachment_indexation', 'digest', 'project', 'ngsd_entrust_dev_helper'],
    ...
    'installable': False,  # Disabled - XML view tag mismatch error for Odoo 18
}
