...
const DocumentsInspector = Widget.extend({
    ...
    events: {
        ...
        'click .o_inspector_folder_delete': '_onFolderDelete',
        'click .o_inspector_download': '_onDownload',
        'click .o_inspector_folder_download': '_onFolderDownload',
    ...
    init: function (parent, params) {
        ...
        this.en_project_id = params.state.en_project_id;
        this.create_date = params.state.create_date;
        this.str_to_datetime = str_to_datetime ;
        this.create_uid = params.state.create_uid;
        this.write_date = params.state.write_date;
        this.write_uid = params.state.write_uid;
        this.can_download = params.state.can_download;
    ...
    _onFolderDelete: function () {
        Dialog.confirm(this, _t("Bạn có chắc chắn muốn xóa thư mục " + this.currentFolder.display_name + " ?"), {
            confirm_callback: () => {
                var documentIds = [this.currentFolder.id];
                this._rpc({
     ...
     * @private
     */
    _onFolderDownload: function () {
        this.trigger_up('folder_download', {
