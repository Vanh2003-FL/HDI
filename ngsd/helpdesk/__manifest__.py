...
Features:
    ...
    'data': [
        ...
        'views/helpdesk_priority.xml',
        'views/helpdesk_urgency.xml',
        'views/helpdesk_infulence.xml',
        'views/helpdesk_source.xml',
        'views/en_type_request_views.xml',
        'views/en_subsystem_views.xml',
        'views/en_system_views.xml',
