...
class HelpdeskTeam(models.Model):
    ...
    def _check_sla_group(self):
        ...
        if sla_teams and not self.env.user.has_group('helpdesk.group_use_sla'):
    ...
    def retrieve_dashboard(self):
        ...
        user_uses_sla = self.env.user.has_group('helpdesk.group_use_sla') and\
...
class HelpdeskStage(models.Model):
    ...
    en_state = fields.Selection(selection=[('draft', 'Mới'),
                                           ...
                                           ('remake', 'Làm lại'),
                                           ('open', 'Mở lại'),
                                           ('close', 'Đóng')], string='Trạng thái ticket')
