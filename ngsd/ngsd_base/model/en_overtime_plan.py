...
class ENOvertimePlan(models.Model):
    ...
    en_reason_ot = fields.Char(string='Lý do OT')
    en_work_inproject = fields.Boolean(string='Công việc trong dự án', readonly=True)
    en_inf_hr_id = fields.Many2one('res.users', string='Gửi thông tin cho HR')
    en_inf_user_id = fields.Many2one('res.users', string='Gửi thông tin cho')
    ...
    en_work_location = fields.Boolean('Làm việc tại văn phòng', default=True)
    en_work_id = fields.Many2one('project.task', string='Công việc', domain="[('id', 'in', en_work_domain)]")
    en_work_nonproject_id = fields.Many2one('en.nonproject.task', string='Công việc', domain="[('id', 'in', en_work_nonproject_domain)]")
    en_date = fields.Date('Ngày OT')
    en_hours = fields.Float('Số giờ OT')
    ...
    en_project_id = fields.Many2one('project.project', 'Dự án', domain="[('id', 'in', en_project_ids)]")
