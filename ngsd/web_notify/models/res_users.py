...
class ResUsers(models.Model):
    ...
    def _notify_channel(
        ...
        # Removed for Odoo 18 compatibility - clean_action not available in web.controllers.main
        # if action:
    ...
    def refresh_form_view(self):
        target = self.env.user.partner_id
        bus_message = {}
        notifications = [[partner, "web.refresh", [bus_message]] for partner in target]
        self.env["bus.bus"]._sendmany(notifications)